...
export const DentalForm = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl font-display font-bold text-navy-800 mb-2">Get in Touch with Us</h3>
      <p className="text-navy-500 mb-6 font-body">And Receive Your Consultation</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="dental-form">
