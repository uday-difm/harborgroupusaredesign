  ...
  return (
    ...
    <section className="max-w-screen-xl mx-auto px-4 py-16 md:py-24 overflow-hidden relative">
      ...
      <div className="text-center mb-16 relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold text-blue-900 mb-4 animate-slide-in-down">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-l-4 border-blue-200 transform transition-all duration-500 hover:shadow-2xl hover:border-blue-400 hover:translate-y-[-10px] animate-fade-in-up delay-200">
          <div className="flex items-center justify-center bg-blue-50 rounded-lg h-16 w-16 mb-6 text-blue-600 shadow-inner">
          ...
          <h3 className="text-2xl font-bold text-blue-800 mb-4">Preventive Services</h3>
        ...
        {/* Basic Services Card */}
        <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-l-4 border-blue-200 transform transition-all duration-500 hover:shadow-2xl hover:border-blue-400 hover:translate-y-[-10px] animate-fade-in-up delay-300">
          <div className="flex items-center justify-center bg-blue-50 rounded-lg h-16 w-16 mb-6 text-blue-600 shadow-inner">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
            </svg>
          </div>
          <h3 className="text-2xl font-bold text-blue-800 mb-4">Basic Services</h3>
          <p className="text-gray-600 mb-6 text-base leading-relaxed">
        ...
        {/* Major Services Card */}
        <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-l-4 border-blue-200 transform transition-all duration-500 hover:shadow-2xl hover:border-blue-400 hover:translate-y-[-10px] animate-fade-in-up delay-400">
          <div className="flex items-center justify-center bg-blue-50 rounded-lg h-16 w-16 mb-6 text-blue-600 shadow-inner">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <h3 className="text-2xl font-bold text-blue-800 mb-4">Major Services</h3>
          <p className="text-gray-600 mb-6 text-base leading-relaxed">
