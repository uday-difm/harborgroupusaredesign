  ...
  return (
    ...
    <section className="max-w-screen-xl mx-auto px-4 py-16 md:py-24 overflow-hidden relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 text-justify">
        ...
        <div className="bg-white p-8 rounded-card card-elevated transform transition-all duration-500 hover:shadow-2xl hover:border-blue-400 hover:translate-y-[-10px] animate-fade-in-up delay-200 ">
          <div className="flex items-center justify-center bg-navy-50 rounded-lg h-16 w-16 mb-6 text-sky-400 shadow-inner">
          ...
          <ul className="space-y-3">
            <li className="flex items-center text-blue-700 font-semibold bg-accent/10 px-4 py-2 rounded-lg shadow-sm">
        ...
        {/* Basic Services Card */}
        <div className="bg-white p-8 rounded-card card-elevated transform transition-all duration-500 hover:shadow-2xl hover:border-sky-400 hover:translate-y-[-10px] animate-fade-in-up delay-300">
          <div className="flex items-center justify-center bg-navy-50 rounded-lg h-16 w-16 mb-6 text-sky-400 shadow-inner">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        {/* Major Services Card */}
        <div className="bg-white p-8 rounded-card card-elevated   transform transition-all duration-500 hover:shadow-2xl hover:border-blue-400 hover:translate-y-[-10px] animate-fade-in-up delay-400">
          <div className="flex items-center justify-center bg-navy-50 rounded-lg h-16 w-16 mb-6 text-sky-400 shadow-inner">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
