  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto px-4 py-16 md:py-24  overflow-hidden relative">
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center gap-12 relative z-10">
        ...
        <div className="flex-1 bg-white p-8 rounded-3xl shadow-xl  border-blue-400 transform transition-all duration-500 hover:shadow-2xl hover:translate-y-[-10px] animate-fade-in-right delay-300">
          <h3 className="text-3xl font-bold text-blue-800 mb-6 text-center">Coverage Scenarios</h3>
          <p className="text-gray-600 mb-8 text-base leading-relaxed text-center">
