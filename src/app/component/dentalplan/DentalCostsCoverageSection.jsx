  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto px-4 py-16 md:py-24  overflow-hidden relative">
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center gap-12 relative z-10">
        {/* Costs Options Block */}
        <div className="flex-1 bg-white p-8 rounded-2xl card-elevated  border-accent transform transition-all duration-500 hover:shadow-2xl hover:translate-y-[-10px] animate-fade-in-left delay-200">
          ...
          <div className="space-y-8">
            <div>
              <h4 className="text-2xl font-semibold text-primary mb-3 flex items-center">
        ...
        <div className="flex-1 bg-white p-8 rounded-2xl card-elevated  border-accent transform transition-all duration-500 hover:shadow-2xl hover:translate-y-[-10px] animate-fade-in-right delay-300">
