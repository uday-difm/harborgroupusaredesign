...
export const PetForm = () => {
  ...
  return (
    <div>
      ...
      <p className="text-navy-500 mb-6 font-body">Reach out to learn more about our pet care plans</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="pet-plan-form">
