...
Open to pet owners, our Pet Plans ensure that comprehensive health protection for your furry friends is within reach
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl card-elevated transition-all duration-300 hover:scale-105 hover:shadow-2xl text-navy-800 flex flex-col items-center text-center border border-navy-100">
            <div className="bg-gradient-to-br from-accent to-accent-light rounded-full p-4 mb-6"> {/* Gradient for icons */}
