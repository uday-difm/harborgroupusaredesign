        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="relative z-10 w-full md:w-3/4 lg:w-2/3 flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between mb-12 animate-fadeInUp">
              <div className="w-20 h-20 rounded-full flex items-center justify-center text-white text-3xl font-bold bg-sky-500 shadow-lg flex-shrink-0 mb-4 md:mb-0 md:mr-8">
                1
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center md:text-left flex-grow">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Tailored Premium Options</h3>
            ...
            <div className="relative z-10 w-full md:w-3/4 lg:w-2/3 flex flex-col md:flex-row-reverse items-center md:items-start justify-center md:justify-between mb-12 animate-fadeInUp delay-100">
              <div className="w-20 h-20 rounded-full flex items-center justify-center text-white text-3xl font-bold bg-sky-500 shadow-lg flex-shrink-0 mb-4 md:mb-0 md:ml-8">
                2
              </div>
