         ...
         Benefits of Critical plan
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center"> {/* Changed gap-12 to gap-16 */}
            ...
            <div className="text-left space-y-6 ">
              <h3 className="text-2xl font-bold text-accent mb-4">Financial Protection for Critical Illness</h3>
              <div className="flex items-start text-gray-700">
                <svg className="w-6 h-6 text-primary mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
            ...
            <div className="flex justify-center animate-slideInRight">
              <Image
                className="object-cover w-full max-w-md h-auto rounded-2xl shadow-2xl  border-navy-200 transform transition-transform duration-700 ease-in-out hover:scale-105"
