...
export const MedicalForm = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl font-display font-bold text-navy-800 mb-2">Fill Out The Form</h3>
      <p className="text-navy-500 mb-6 font-body">And Receive Your Consultation</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="medical-form">
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="message" className="block text-sm font-semibold text-navy-800 mb-1">Message*</label>
            <textarea
              id="message"
              name="message"
          ...
          <div className="flex items-start">
            ...
            <label htmlFor="consent" className="text-sm text-navy-600">
              I agree to the <a href="/terms-and-conditions" className="text-accent underline">terms and conditions</a>.
            </label>
          </div>
        </div>
        ...
        >
          {issubmiting ? 'Submitting...' : 'Get Your Medical Plan'}
        </button>
      </form>
    </div>
  );
