...
export const GetYourPersonalizedMedicalPlan = () => {
  return (
    <div>
      ...
      <div className="w-full  mx-auto bg-blue-50  p-8 sm:p-12  flex flex-col items-center justify-center animate-slideInUp relative overflow-hidden">
        ...
        <h2 className="text-4xl lg:text-5xl font-extrabold mb-8 text-center text-blue-900 relative z-10">
          Get Your Personalized Medical Plan
        </h2>
        <Link href ="#medical-form" className="bg-blue-600 text-white font-bold py-3 px-10 rounded-full shadow-lg hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75 relative z-10">
          GET STARTED
        </Link>
      </div>
    </div>
