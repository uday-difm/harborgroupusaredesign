...
export const BenefitsVisionplan = () => {
  return (
    <div className="min-h-screen bg-surface font-inter py-20 md:py-28 px-4 md:px-8">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 flex flex-col items-center text-center opacity-0 animate-fadeInSlideUp delay-200 hover:shadow-xl transition-shadow duration-300">
          ...
          <ul className="text-left text-navy-500 space-y-2">
            <li className="flex items-start">
              <span className="text-accent mr-2 mt-1"> {/* Changed from text-accent */}
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 flex flex-col items-center text-center opacity-0 animate-fadeInSlideUp delay-300 hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 flex flex-col items-center text-center opacity-0 animate-fadeInSlideUp delay-400 hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 flex flex-col items-center text-center opacity-0 animate-fadeInSlideUp delay-500 hover:shadow-xl transition-shadow duration-300">
          <div className="mb-4 text-accent animate-iconBounce" style={{ animationDelay: '1.5s' }}>
