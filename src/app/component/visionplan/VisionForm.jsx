...
export const VisionForm = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl font-display font-bold text-navy-800 mb-2">Network Form</h3>
      <p className="text-navy-500 mb-6 font-body">Accessing top-notch eye care is effortless</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="vision-form">
