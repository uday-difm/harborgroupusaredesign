    ...
    <div className=" bg-gradient-to-br from-blue-50 to-gray-100 font-inter py-16 px-4 md:px-8">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 opacity-0 animate-fadeInSlideRight delay-300 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 opacity-0 animate-fadeIn delay-400 hover:shadow-xl transition-shadow duration-300">
            <div className="mb-4 flex items-center justify-center text-sky-500">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 opacity-0 animate-fadeInSlideLeft delay-500 hover:shadow-xl transition-shadow duration-300">
            ...
            <ul className="text-left text-gray-600 space-y-3">
              ...
              <li className="flex items-start">
                ...
                Get guidance from our agent on what's covered and plan accordingly
              </li>
            </ul>
          </div>
