...
export const LayeredCosts = () => {
  return (
    <div className=" bg-gradient-to-br from-navy-50 to-navy-50 font-inter py-20 md:py-28 px-4 md:px-8">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-full h-1 bg-navy-100 opacity-40 animate-fadeIn delay-200"></div>
          <div className="absolute w-1 h-full bg-navy-100 opacity-40 animate-fadeIn delay-300"></div>
        </div>
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 opacity-0 animate-fadeInSlideRight delay-300 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 opacity-0 animate-fadeIn delay-400 hover:shadow-xl transition-shadow duration-300">
            <div className="mb-4 flex items-center justify-center text-accent">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl card-elevated border border-navy-100 opacity-0 animate-fadeInSlideLeft delay-500 hover:shadow-xl transition-shadow duration-300">
            <div className="mb-4 flex items-center justify-center text-accent">
