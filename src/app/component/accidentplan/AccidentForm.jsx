...
export const AccidentForm = () => {
  ...
  return (
    <div>
      ...
      <p className="text-navy-500 mb-6 font-body">Reach out to learn more about our accident plans</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="accident-plan-form">
