...
export const MajorMedicalForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(data.message || 'Your application has been submitted successfully!');
  ...
  return (
    <div>
      <h3 className="text-2xl font-display font-bold text-navy-800 mb-2">Request a Call Back?</h3>
      <p className="text-navy-500 mb-6 font-body">Reach out to learn more about our major medical plans</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="major-medical-plan-form">
