...
export const CostOption = () =>{
  return (
    <>
      ...
      <HarborArc position="topLeft" className="text-navy-900 opacity-5" />
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl card-elevated border border-navy-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 text-center">
            ...
            <ul className="space-y-3 text-navy-500 text-lg text-left">
              <li className="flex items-start">
                ...
                <span className='text-justify'>Explore different premium plans designed for varying levels of medication coverage</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-accent flex-shrink-0 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                <span className='text-justify'>Tailor your plan to align precisely with your financial priorities for medication</span>
              </li>
            </ul>
          </div>
          <div className="bg-white p-8 rounded-2xl card-elevated border border-navy-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 text-center">
            ...
            <ul className="space-y-3 text-gray-6 text-lg text-left">
              <li className="flex items-start">
                ...
                <span className='text-justify'>Benefit from an easy-to-understand co-payment structure for prescription medications</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-accent flex-shrink-0 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                <span className='text-justify'>Know your medication costs upfront, ensuring financial transparency</span>
              </li>
            </ul>
          </div>
          <div className="md:col-span-2 lg:col-span-1 bg-white p-8 rounded-2xl card-elevated border border-navy-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 text-center">
            ...
            <ul className="space-y-3 text-navy-500 text-lg text-left">
              <li className="flex items-start">
                ...
                <span className='text-justify'>Delve into clearly defined coverage scenarios for various prescription medications</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-accent flex-shrink-0 mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                <span className='text-justify'>Easily understand what's covered, allowing you to plan accordingly for your medication needs</span>
              </li>
            </ul>
          </div>
        </div>
