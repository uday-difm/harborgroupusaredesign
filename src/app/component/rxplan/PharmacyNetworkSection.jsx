    ...
    <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white to-blue-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto  overflow-hidden ">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center text-navy-800 order-1 lg:order-2">
            <h2 className="text-4xl font-extrabold mb-6 leading-tight text-navy-800">
              Network
            </h2>
            <p className="text-lg leading-relaxed mb-10 text-navy-500 text-justify">
            ...
            <div className="space-y-8">
              <div className="flex items-start bg-white p-6 rounded-card card-elevated border border-navy-100 transform transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy-800 mb-2">Qualified Pharmacy Professionals</h3>
              ...
              <div className="flex items-start bg-white p-6 rounded-card card-elevated border border-navy-100 transform transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy-800 mb-2">Nationwide Coverage</h3>
                  <p className="text-base text-navy-500 text-justify">
              ...
              <div className="flex items-start bg-white p-6 rounded-card card-elevated border border-navy-100 transform transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy-800 mb-2">Dedicated Support</h3>
                  <p className="text-base text-navy-500 text-justify">
