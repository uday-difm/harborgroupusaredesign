...
export const RxForm = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl font-display font-bold text-navy-800 mb-2">Start your Plan Today!</h3>
      <p className="text-navy-500 mb-6 font-body">Reach out to learn more about our Rx plans</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="rx-plan-form">
