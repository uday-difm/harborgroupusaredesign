...
export const EligibilitycriteriaofHospital = ()=> {
  ...
  return (
    <>
     <section className="relative w-full bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 transform transition duration-300 hover:scale-105 hover:shadow-xl animate-delayFadeIn flex flex-col justify-between">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Resident of the United States</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 transform transition duration-300 hover:scale-105 hover:shadow-xl animate-delayFadeIn-2 flex flex-col justify-between">
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
            ...
            {/* Card 3: Citizenship */}
            <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 transform transition duration-300 hover:scale-105 hover:shadow-xl animate-delayFadeIn-3 flex flex-col justify-between">
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Citizenship</h3>
              <p className="text-gray-700 text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 transform transition duration-300 hover:scale-105 hover:shadow-xl animate-delayFadeIn-4 flex flex-col justify-between">
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
