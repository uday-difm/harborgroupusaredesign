...
export const HospitalForm = () => {
  ...
  return (
    <div>
      ...
      <p className="text-navy-500 mb-6 font-body">Reach out to learn more about our hospital plans</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="hospital-plan-form">
