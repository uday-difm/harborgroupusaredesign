    ...
    <>
      ...
      <section className="w-full section-light py-20 md:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch"> {/* Changed items-center to items-stretch */}
          ...
          <div className="flex justify-center lg:justify-start  h-full"> {/* Added h-full */}
            <Image
              className="w-full h-full object-cover rounded-2xl shadow-2xl  transform transition-transform duration-700 ease-in-out hover:scale-105" /* Added h-full and object-cover */
