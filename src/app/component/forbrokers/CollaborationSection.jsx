      ...
      <div className="max-w-6xl mx-auto md:flex md:flex-row-reverse">
        <div className="md:w-1/2 flex items-center justify-center p-6 md:p-12">
          <div className="relative w-full h-80 md:h-full">
            <Image
              className="absolute inset-0 object-cover rounded-card transform hover:scale-105 transition-transform duration-300 ease-in-out"
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col  text-gray-800">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-navy-800">
            Collaborate with Us!
          </h1>
          ...
          <Link
            href="#broker-form"
            className="self-start px-8 py-4 bg-accent text-white font-bold text-lg rounded-full card-elevated hover:bg-sky-400 transform hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-indigo-300 focus:ring-opacity-75"
          >
            APPLY NOW
          </Link>
