    ...
    <section className="h-screen flex items-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-blue-100 font-inter">
      <div className="max-w-6xl mx-auto md:flex md:flex-row-reverse">
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col  text-gray-800">
          ...
          <button className="self-start px-8 py-4 bg-sky-500 text-white font-bold text-lg rounded-full shadow-lg hover:bg-indigo-700 transform hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-indigo-300 focus:ring-opacity-75">
            APPLY NOW
          </button>
        </div>
      </div>
