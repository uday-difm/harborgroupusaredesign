...
export const CostOptions = () => {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 font-inter flex items-center justify-center p-4 sm:p-8`}>
      <div className="max-w-6xl w-full bg-white shadow-lg rounded-xl overflow-hidden md:flex flex-row-reverse"> {/* flex-row-reverse to put image on left */}
         {/* Left Section: Image (now on the left due to flex-row-reverse) */}
       
        {/* Right Section: Content (now on the right due to flex-row-reverse) */}
 ...
 <div className="md:w-1/2 flex items-center justify-center p-4 md:p-0">
          <img
            src="https://harborgroupusa.s3-eu-central-2.ionoscloud.com/home/lifestyle-Cost-Options.jpeg" // Path to your main image
