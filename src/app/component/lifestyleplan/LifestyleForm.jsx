...
export const LifestyleForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(data.message || 'Thank you for your submission! We will get back to you soon.');
  ...
  return (
    <div>
      ...
      <p className="text-navy-500 mb-6 font-body">Reach out to learn more about our lifestyle plans</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="lifestyle-plan-form">
