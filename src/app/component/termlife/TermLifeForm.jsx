...
export const TermLifeForm = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl font-display font-bold text-navy-800 mb-2">Get in Touch</h3>
      <p className="text-navy-500 mb-6 font-body">Access a Network of Top-Notch professionals</p>

      <form className="space-y-6 font-body" onSubmit={handleSubmit} id="term-form">
