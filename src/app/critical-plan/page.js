...
export default function CriticalPlanPage() {
  ...
  return (
    <>
      ...
      <PlanHero breadcrumbs={[{ label: "Home", href: "/" }, { label: "Health Plans", href: "/health-plans" }, { label: "Critical Plan" }]}
      ...
      <PlanHowToApply
        title="How To Apply"
        description="At Harbor Group USA, getting the coverage you need is a straightforward process. Follow these simple steps to enroll in your Critical Plan."
      />
