...
//      subject: "🎉 Welcome to 1stAlliance Group – You're Subscribed!",
//   body: `
//   <div style="font-family: 'Helvetica Neue', sans-serif; max-width: 600px; margin: auto; color: #2c3e50;">
//     <h2 style="color: #008fa3;">Welcome to 1stAlliance Group!</h2>
...
//       <p>
//         Best regards,<br />
//         <strong>The 1stAlliance Group Team</strong><br />
//         <i>Empowering financial excellence</i>
//       </p>
//     </div>
//   </div>
//   `,
//   footer: "© 2025 1stAlliance Group. All rights reserved.",
//     });
    ...
    // await sendMail({
    //   to: email,
    //   subject: "🎉 You're subscribed to 1stAlliance Group",
    //   html: emailContent,
    // });
