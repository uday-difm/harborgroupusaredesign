...
export async function POST(req) {
    ...
    try {
       ...
       // console.log({ blogTitle, blogTag, description, content, blogCategoryId, date, time, imageFile: imageFile ? 'File received' : 'No file received', blogPublisherId, manualBlogSlug });
