...
export async function POST(req) {
  try {
    ...
    const emailContent = generateEmailTemplate({
      subject: "👤 New Individual Plan Submission",
      body: `
        <div style="font-family: Arial, sans-serif; color: #333;">
          <h2>New Individual Plan Submission</h2>
    ...
    await sendMail({
      ...
      subject: "👤 New Individual Plan Submission Received",
      html: emailContent,
    });
    ...
    console.error("Error processing individual plan form:", error);
    return new Response(
