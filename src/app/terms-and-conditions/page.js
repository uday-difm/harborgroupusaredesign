    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 font-inter overflow-hidden">
      <div className="relative bg-white rounded-3xl shadow-xl p-8 md:p-12 max-w-5xl w-full text-left transform transition-all duration-700 ease-out animate-fade-in-up">
        ...
        <div className="space-y-8 text-gray-700 animate-fade-in-delay-text">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-3">Communication, Contact, and Internships</h2>
            <ol className="list-decimal list-inside space-y-2 pl-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-3">Advertising and Branding</h2>
            <ol className="list-decimal list-inside space-y-2 pl-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-3">Third-Party Content and Press</h2>
            <ol className="list-decimal list-inside space-y-2 pl-4">
          ...
          {/* Diversity Project */}
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-3">Diversity Project</h2>
            <ul className="list-disc list-inside space-y-2 pl-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-3">Regulatory Information</h2>
            <p className="text-base leading-relaxed">
              The Harbor Group operates in accordance with the regulations set forth by <strong className="font-semibold">Regulatory Authorities</strong>. Our commitment to compliance ensures that our health plan services adhere to industry standards and legal requirements. For specific regulatory details, please refer to the relevant documentation provided by <strong className="font-semibold">Regulatory Authorities</strong>.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-base leading-relaxed">
              If you have any questions or concerns regarding our Privacy Policy, Terms and Conditions, or regulatory compliance, please contact us at <a href="mailto:doug@bhgsfl.com" className="text-blue-600 hover:underline">doug@bhgsfl.com</a>.
            </p>
