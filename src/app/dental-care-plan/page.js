...
export default function DentalPlanPage() {
  ...
  return (
    <>
      ...
      <PlanHowToApply
        title="How To Apply"
        description="At Harbor Group USA, getting the coverage you need is a straightforward process. Follow these simple steps to enroll in your Dental Care Plan."
      />
