...
export default function notfound() {
  return (
    <div>
      <section className="relative min-h-screen flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white to-navy-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto  p-8 sm:p-12 lg:p-16  text-center  flex flex-col items-center justify-center">
        ...
        <div className="mb-8 w-48 h-48 sm:w-64 sm:h-64 flex items-center justify-center">
          <svg className="w-full h-full text-accent animate-bounce-slow" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center justify-center px-8 py-4 border-2 border-transparent rounded-full text-xl font-semibold text-white bg-primary hover:bg-primary-hover shadow-lg uppercase tracking-wider transition-all duration-300 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent transform hover:-translate-y-0.5"
        >
          Go to Homepage
        </Link>
      </div>
